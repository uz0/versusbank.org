...
## Rationale
{"anomaly": "Stardew Valley-like performance in web browser requires optimized engine", "approach": "Native web technologies without abstraction layers", "alternatives_rejected": ["Game frameworks (overhead)", "Unity/WebGL (large bundle size)"]}